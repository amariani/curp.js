...
(function(global) {
  'use strict';
  var comunes = constants.commonNames;
  /**
    curp.js
  ...
  */
  ...
  function filtraInconvenientes(str) {
    var inconvenientes = constants.inconvenients;
  ...
  function ajustaCompuesto(str) {
    var compuestos = constants.compounds;
  ...
  function normalizaString(str) {
    ...
    origen = constants.origins;
    destino = constants.destinations;
    str = str.split('');
